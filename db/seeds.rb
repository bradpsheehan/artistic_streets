file = File.open('./app/assets/images/seed_photos/02143_03.jpg')
...
file = File.open('./app/assets/images/seed_photos/02108_01.jpg')
...
file = File.open('./app/assets/images/seed_photos/02143_01.jpg')
art1 = Art.create( image: file, location_attributes: { address: '84-98 Lowell St, Somerville, MA 02143'})
file.close

# file = File.open('./app/assets/images/seed_photos/02143_02.jpg')
...
file = File.open('./app/assets/images/seed_photos/02143_04.jpg')
...
file = File.open('./app/assets/images/seed_photos/02143_05.jpg')
art1 = Art.create( image: file, location_attributes: { address: 'Osgood Park, Somerville, MA 02143'})
file.close

file = File.open('./app/assets/images/seed_photos/02143_07.jpg')
...
file = File.open('./app/assets/images/seed_photos/02143_08.jpg')
...
file = File.open('./app/assets/images/seed_photos/02143_10.jpg')
...
file = File.open('./app/assets/images/seed_photos/02144_01.jpg')
