file = File.open('https://s3-us-west-2.amazonaws.com/artisticstreets/arts/images/000/000/001/medium/02143_03.jpg')
...
file = File.open('https://s3-us-west-2.amazonaws.com/artisticstreets/arts/images/000/000/002/medium/02108_01.jpg')
...
file = File.open('https://s3-us-west-2.amazonaws.com/artisticstreets/arts/images/000/000/003/medium/02143_01.jpg')
art1 = Art.create( image: file, location_attributes: { address: '84-98 Lowell St, Somerville, MA 02143'})
file.close

file = File.open('https://s3-us-west-2.amazonaws.com/artisticstreets/arts/images/000/000/004/medium/02143_04.jpg')
...
file = File.open('https://s3-us-west-2.amazonaws.com/artisticstreets/arts/images/000/000/005/medium/02143_05.jpg')
art1 = Art.create( image: file, location_attributes: { address: 'Osgood Park, Somerville, MA 02143'})
file.close

file = File.open('https://s3-us-west-2.amazonaws.com/artisticstreets/arts/images/000/000/006/medium/02143_07.jpg')
...
file = File.open('https://s3-us-west-2.amazonaws.com/artisticstreets/arts/images/000/000/007/medium/02143_08.jpg')
...
file = File.open('https://s3-us-west-2.amazonaws.com/artisticstreets/arts/images/000/000/008/medium/02143_10.jpg')
...
file = File.open('https://s3-us-west-2.amazonaws.com/artisticstreets/arts/images/000/000/009/medium/02144_01.jpg')
...
file = File.open('https://s3-us-west-2.amazonaws.com/artisticstreets/arts/images/000/000/010/medium/02143_09.jpg')
art1 = Art.create(artist: "Os Gemeos", image: file, location_attributes: { address: '2-18 Webster Ave, Somerville, MA 02143'})
file.close

file = File.open('https://s3-us-west-2.amazonaws.com/artisticstreets/arts/images/000/000/011/medium/02145_01.jpg')
art1 = Art.create(image: file, location_attributes: { address: '320 Broadway, Somerville, MA 02145'})
file.close

file = File.open('https://s3-us-west-2.amazonaws.com/artisticstreets/arts/images/000/000/012/medium/02145_02.jpg')
